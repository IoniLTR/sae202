...
<form action="/User/resultatRechercheJardin.php" method="get">
...
try {
    if (isset($_GET['texte']) && !empty($_GET['texte'])) {
        ...
        foreach ($jardins as $jardin) {
            ...
            echo '<img class="w-full h-full" src="/assets/Uploads/' . htmlspecialchars($jardin['img']) . '"></img>';
            ...
            if (!empty($jardin['userName']) && !empty($jardin['userForname']) && !empty($jardin['userEmail'])) {
                echo '<p>' . htmlspecialchars($jardin['userName']) . ' ' . htmlspecialchars($jardin['userForname']) . '</p>';
